...
/**
 * Profil fotoğrafı path'ini full S3 URL'ine dönüştürür
 * Eğer zaten bir URL ise olduğu gibi döner
 * Eğer null/undefined ise null döner
 */
export function transformProfileImageUrl(imagePath: string | null | undefined): string | null {
  ...
  // S3 path ise tam URL'e dönüştür
