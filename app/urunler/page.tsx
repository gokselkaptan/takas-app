          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="relative">
              ...
              >
                ...
                {userLocation && <option value="distance">{t('nearestFirst')}</option>}
              </select>
              <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-orange-400 pointer-events-none" />
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-6 py-3 bg-[#1877F2] text-white font-semibold rounded-xl hover:scale-105 transition-transform shadow-lg"
            >
