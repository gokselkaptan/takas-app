...
// Caveat Font - Post-it Notes için
const caveat = Caveat({
  subsets: ['latin'],
  weight: ['400', '700'],
  display: 'swap',
  ...
  return (
    <html lang="tr" suppressHydrationWarning translate="no" className="notranslate">
      <head>
        ...
        {/* Caveat Font artık next/font ile yükleniyor - harici link gereksiz */}
        {/* PWA Meta Tags */}
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window, document, "clarity", "script", "w560s7u3pq");
            `,
          }}
        />
      </head>
      <body className={`${caveat.variable} min-h-screen bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 antialiased transition-colors duration-300`}>
        <ConnectionStatus />
        <UpdateManager />
        <ThemeProvider
          attribute="class"
