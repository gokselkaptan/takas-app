      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center justify-between mb-10">
          <div className="space-y-2">
            ...
            <div className="animate-pulse bg-gray-200 h-5 w-48 rounded-lg" />
          </div>
          <div className="animate-pulse bg-gray-200 h-12 w-36 rounded-xl hidden sm:block" />
        </div>
        {/* Product Cards Skeleton */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[...Array(8)].map((_, i) => (
            <ProductCardSkeletonInline key={i} />
          ))}
        </div>
      </div>
    </section>
...
// Inline skeleton to avoid client component import in server component
  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm">
      ...
      <div className="p-4 space-y-3">
        {/* Category badge */}
        <div className="animate-pulse bg-gray-200 h-5 w-20 rounded-full" />
        {/* Title */}
