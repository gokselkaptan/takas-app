...
export function PWAProvider({ children }: { children: React.ReactNode }) {
  ...
  const checkServerSubscription = async () => {
    try {
      ...
      // Eğer sunucuda subscription yoksa ama izin verilmişse, otomatik yenile
      if (!data.subscribed && pushSupported && Notification.permission === 'granted') {
        console.log('[Push] No active subscription but permission granted, auto-refreshing...')
  ...
  // Subscription'ı sessizce yenile (izin zaten verilmişse)
