...
export const metadata: Metadata = {
  ...
  title: {
    default: 'TAKAS-A | Global Ücretsiz Takas Platformu – Para Ödemeden Takas Et',
    template: '%s | TAKAS-A'
  },
  description: 'Dünyadaki tüm şehirlerde ücretsiz takas platformu! Para ödemeden ürünlerini takas et, sürdürülebilir ekonomiye katkıda bulun. Global çapta paylaşım ekonomisi – Takas-A ile hemen başla!',
  keywords: [
    ...
    'swap', 'worldwide swap', 'free exchange', 'Barcelona', 'İstanbul', 'Ankara'
  ],
  ...
  openGraph: {
    ...
    siteName: 'TAKAS-A',
    title: 'TAKAS-A | Global Ücretsiz Takas Platformu',
    description: 'Dünyadaki tüm şehirlerde para ödemeden takas yap! Sürdürülebilir paylaşım ekonomisi – Takas-A ile hemen başla.',
    images: [{
      url: '/og-image.png',
      width: 1200,
      height: 630,
      alt: 'TAKAS-A - Paylaşımın Geleceği – Her Şehirde Ücretsiz Takas'
    }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'TAKAS-A | Global Ücretsiz Takas Platformu',
    description: 'Dünyadaki tüm şehirlerde para ödemeden takas yap! Sürdürülebilir paylaşım ekonomisi.',
    images: ['/og-image.png'],
